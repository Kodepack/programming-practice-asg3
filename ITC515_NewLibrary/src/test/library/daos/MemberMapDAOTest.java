...
public class MemberMapDAOTest {
	...
	public void testFindMembersByLastName(){
		...
		List<IMember> memberList = memberMapDAO.findMembersByLastName(MEMBER_01_LAST_NAME);
		IMember member = memberList.get(0);
	...
	public void testFindMembersByNames(){
		...
		//Lets try to find member by last name
		List<IMember> memberList = memberMapDAO.findMembersByNames(MEMBER_01_FIRST_NAME, MEMBER_01_LAST_NAME);
		IMember member = memberList.get(0);
